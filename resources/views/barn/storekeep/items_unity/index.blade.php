...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="d-flex align-items-center">
            <div class="ms-auto">
                <a href="{{ route('storekeeper_role.item_unity.create') }}" class="btn btn-primary px-3"><i class="bx bx-plus"></i>Yangi Birlik nomi</a>
            </div>
        </div>
                        ...
                        <table class="table table-bordered align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="fixed_header2 align-middle">Birlik  nomi</th>
                            ...
                            <tbody>
                                ...
                                {{-- <td class="d-flex align-items-center">
                                  ...
                                  <td> <a href="{{ route('storekeeper_role.item_unity.edit',['item_unity'=>$unity->id]) }}" class="btn btn-sm btn-warning text-white me-2"></i>O'zgartirish</a></td>
                                  {{-- <td>
