...
<div class="page-wrapper">
    ...
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Jihoz birligi o'zgartirish</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ route('storekeeper_role.actions.index') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Jihoz birligi</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="col-xl-10 mx-auto">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <form class="row g-3" method="post" action="{{ route('storekeeper_role.item_unity.update',['item_unity'=>$id])}}">
                            @csrf
                            @method("PUT")
                          
                            <div class="col-md-8 mb-3" >
                                <label for="full_name" class="form-label">Jihoz nomi</label>
                                <input type="text" name="name" value="{{ $unity->name }}" class="form-control" id="full_name">
                            </div>
                            {{-- <div class="col-md-8 mb-3">
