...
<div class="page-wrapper">
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Jihoz nomi</div>
            <div class="ps-3">
        ...
        <div class="d-flex align-items-center">
            <h6 class="mb-0 text-uppercase">Jihoz nomi</h6>
        </div>
        
        <div class="d-flex align-items-center">
            <div class="ms-auto">
                <a href="{{ route('storekeeper_role.second_type_item.create') }}" class="btn btn-primary px-3"><i class="bx bx-plus"></i>Yangi Jihoz nomi</a>
            </div>
        </div>
                        ...
                        <table class="table table-bordered align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                {{-- <td class="d-flex align-items-center">
                                  ...
                                  <td> <a href="{{ route('storekeeper_role.second_type_item.edit',['second_type_item'=>$second_type->id]) }}" class="btn btn-sm btn-warning text-white me-2"></i>O'zgartirish</a></td>
                                  {{-- <td>
