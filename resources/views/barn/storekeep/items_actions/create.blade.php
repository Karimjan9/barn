...
<div class="page-wrapper">
    ...
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Jihoz qo'shish</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="{{ route('storekeeper_role.actions.index') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Yangi jihoz</li>
                    </ol>
                </nav>
            </div>
        </div>
        <div class="row">
            <div class="col-xl-10 mx-auto">
                <h6 class="mb-0 text-uppercase">Jihoz qo'shish</h6>
                <hr>
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">

                        <form class="row g-3" method="post" action="{{ route('storekeeper_role.items.store')}}">
                            @csrf
                            <div class="col-md-8 mb-3" >
                                <label for="full_name" class="form-label">Jihoz modeli</label>
                                <input type="text" name="name" class="form-control" id="full_name">
                            </div>
                           {{-- @dd($bodilys) --}}
                            <div class="col-md-8 mb-3">
                                {{-- <input type="number"     id="" value="0.0"> --}}
                                <label for="bodily" class="form-label">Moddiylik turi</label>
                       ...
                       <div class="col-md-8 mb-3">
                        ...
                        {{-- <div class="col-md-8 mb-3" >
                            <label for="full_name" class="form-label">Come</label>
                            <input type="number" name="extant" class="form-control" id="extant">
                        </div> --}}
                        <div class="col-md-12">
