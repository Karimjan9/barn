                        ...
                        <table class="table table-bordered align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="fixed_header2 align-middle">Mahsulot nomi</th>
                                ...
                                {{-- <td>{{ $ask->number_of_item ?? "1"}}</td> --}}
                                  <td>
                                    <div class="container">
                                        ...
                                        <div class="col-12">
                                            <button id="but_submit" type="submit" class="btn btn-primary px-5" disabled>Olindi</button>
                                        </div>
