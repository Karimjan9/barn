...
<div class="page-wrapper">
    ...
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Ariza O'zgartirish</div>
            <div class="ps-3">
        ...
        <div class="row">
            <div class="col-xl-10 mx-auto">
                <h6 class="mb-0 text-uppercase">Ariza o'zgartirish</h6>
                <hr>
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">

                        <form class="row g-3" method="post" action="{{ route('user_role.users_petitions.update',['users_petition'=>$id])}}">
                            @csrf
                          @method('PUT')
                            <div class="col-md-8 mb-3">
                                ...
                                <label for="first_type" class="form-label">Jihoz turi</label>
                                        ...
                                        <option value="{{ $first->id }}" 
                                            @if ($edit_petition['type']==$first->id)
                                                @selected(true)
                                            @endif
                           ...
                           <div class="col-md-8 mb-3" >
                                ...
                                <input type="number" value="{{ $edit_petition['number'] }}" name="number" class="form-control" id="count" >
                             </div>
                             <div class="col-md-8 mb-3" >
                                <label for="full_name" class="form-label">Mulohaza</label>
                            <br />
                                <textarea rows="10"  name="description" cols="50" placeholder="Describe yourself here...">{{ $edit_petition['description'] }}</textarea>
                             </div>
                          
                            <div class="col-12 mb-3">
                                <button type="submit" class="btn btn-primary px-5">O'zgaritish</button>
                            </div>
