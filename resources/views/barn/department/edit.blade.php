            ...
            <div class="col-xl-10 mx-auto">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <hr>
                        <form class="row g-3" method="post" action="{{ route('kadr_role.department_employee.update',['department_employee'=>$departament->id]) }}">
                            @csrf
                            @method("PUT")
                            {{-- <div class="col-md-12">
                      ...
                      @endforeach --}}
                            <div class="col-md-12">
                                ...
                                <input type="text" name="department_name" value="{{ $departament->name }}" class="form-control" id="message_body">
                            </div>
                            <br>
