                        ...
                        <table class="table table-bordered align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="fixed_header2 align-middle" scope="col">Avvalgi mansab</th>
                                    <th class="fixed_header2 align-middle" scope="col">Hozirgi mansab</th>
                            ...
                            <tbody>
                                ...
                                {{-- @dd( $command->get_old_job->get_departament->name) --}}
                                    <tr>
                                        <td>
                                            {{ ++$i }}
                                        </td>
                                        ...
                                        <td>
                                            {{$command->get_old_job->get_departament->name ?? "Department"}}
                                        </td>
                                        <td>
                                            {{ $command->get_new_job->get_departament->name ?? "Department"}}
                                        </td>
                                        <td>
                                            {{$command->get_old_job->get_career->career_name ?? "Command"}}
                                        </td>
                                        <td>
                                            {{ $command->get_new_job->get_career->career_name ?? "Career"}}
                                        </td>
                                        <td>
