...
<div class="page-wrapper">
    <div class="page-content">
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Jihozlarni ko'rish</div>
            <div class="ps-3">
                        ...
                        <table class="table table-bordered align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="fixed_header2 align-middle">Jihoz Qoldig'i</th>
...
<script>
  ...
  $.ajax('{{ route('bugalter_role.ajax_acco_second_types') }}', {
      type : "GET",
      data : {
...
<script>
        ...
        $.ajax('{{ route('bugalter_role.accountant_without_bodily') }}', {
            type : "GET",
            data : {
...
<script>
  ...
  $.ajax('{{ route('bugalter_role.accountant_with_bodily') }}', {
      type : "GET",
      data : {
          'second_filter' : $('#second_filter').val(),
          'first_filter' : $('#first_filter').val(),
